...
namespace SunFarm.Customers
{
    ...
    public partial class Custinq : ASNA.QSys.HostServices.Program
    {
        ...
        FixedString<_3> _lb_pNbrsAlf { get => _DS0.GetString(0, 3); set => _DS0.SetString(((string)value).AsSpan(), 0, 3); } 
        ...
        FixedDecimal<_9, _0> CmCust_lb_;
        FixedString<_13> SalesCh;
        FixedString<_13> ReturnsCh;
        FixedString<_9> CmCust_lb_CH;
        FixedDecimal<_5, _0> X;
        DataStructure _DS1 = new DataStructure(9);
...
#region Constructor and Dispose 
        ...
        void StarEntry(int _pc_parms)
        {
            ...
            do
            {
                do
                {
                    ...
                    {
                        Name40 = SETNAME.MoveLeftWithPad(Name40);
                    ...
                    else
                    {
                        ...
                        do
                        {
                            ...
                            if (!(bool)_IN[66])
                            {
                                if (SFSEL == 10)
                                {
                                    ...
                                    _lb_pNbrs = _lb_pNbrs + 1;
                                    pNumbers[(int)(_lb_pNbrs - 1)] = (decimal)SFCUSTNO;
                                    pTypes[(int)(_lb_pNbrs - 1)] = "P";
                                    ClearSel();
                                }
                                else if (SFSEL == 9)
                                {
                                    ...
                                    DynamicCaller_.CallD("SunFarm.Customers.CUSTPRTS", out _IN.Array[88], ref _SVCUSTNOaProxy);
                                ...
                                else if (SFSEL == 5)
                                {
                                    ...
                                    DynamicCaller_.CallD("SunFarm.Customers.CUSTDELIV", out _IN.Array[88], ref pNumber);
                                    ClearSel();
                                }
                                else if (SFSEL == 3)
                                {
                        ...
                        {
                            //Are there any jobs
                            DynamicCaller_.CallD("SunFarm.Customers.CUSTSBMJOB", out _IN.Array[88], ref pNumbers, ref pTypes); // to submit to batch?
                            MID = "CST0005";
                            MTX = (string)_lb_pNbrsAlf;
                            DynamicCaller_.CallD("SunFarm.Customers.MSGLOD", out _LR, ref MID, ref MTX);
                        }
                        sflrrn = savrrn;
                    }
        ...
        void RcdUpdate()
        {
            ...
            do
            {
                ...
                else if ((bool)_IN[4])
                {
                    ...
                    {
                        DynamicCaller_.CallD("SunFarm.Customers.CUSTPRMPT", out _IN.Array[88], ref CSRFLD, ref pResult);
                        if (!pResult.IsBlanks())
                        {
                            if (CSRFLD == "SFSTATE")
        ...
        void SalesInfo()
        {
            ...
            Sales = 0;
            Returns = 0;
            CmCust_lb_CH = CMCUSTNO.MoveRight(CmCust_lb_CH);
            SalesCh = new string('0', 13);
            ReturnsCh = new string('0', 13);
            DynamicCaller_.CallD("SunFarm.Customers.CUSTCALC", out _IN.Array[88], ref CmCust_lb_CH, ref SalesCh, ref ReturnsCh);
            SFNAME = CMNAME;
...
#region CopyBook "..\Copybooks\ErnuboCustchk.vr"
        // ASNA Monarch(R) version 10.0.3.0 at 9/28/2020
        // Migrated source location: library ERNUBO, file QRPGSRC, member CUSTCHK
        ...
        void CustChk()
        {
            // *NoLock is not supported on DSS 
            //if (LockRec == "N")
...
#region File Information Data Structures
        ...
        int STATUS
        {
            get { return CUSTDSPF.StatusCode; }
...
#region Entry and activation methods for *ENTRY
    ...
    //Error  There are 1 NoLock Read operations. Using *NoLock on a file opened for *Update is not supported with DSS .NET
