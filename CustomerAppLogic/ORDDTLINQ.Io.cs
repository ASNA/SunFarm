...
namespace SunFarm.Customers
{
    ...
    public partial class Orddtlinq
    {
        ...
        private static Dictionary<string, string> ORDERHDRL2_ReadOnlyFormatIDs = new Dictionary<string, string>()
        {
            { "RORDRHDR", "HGKtY5i8LuqjN1v8eIQidC7WD6Q=" }
        };
        ...
        private void PopulateBufferORDERHDRL2_ReadOnly(string _, AdgDataSet _dataSet)
        {
            var _table = _dataSet.GetAdgTable("*FILE");
            System.Data.DataRow _row = _table.Row;
            _row["ORDNUM"] = ((decimal)(ORDNUM));
        ...
        private void PopulateFieldsORDERHDRL2_ReadOnly(string _, AdgDataSet _dataSet)
        {
            var _table = _dataSet.SetActive("*FILE");
            System.Data.DataRow _row = _table.Row;
            ORDNUM = ((decimal)(_row["ORDNUM"]));
