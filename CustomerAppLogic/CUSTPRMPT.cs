...
// Migrated source location: library ERNUBO, file QRPGSRC, member CUSTPRMPT
...
namespace SunFarm.Customers
{
    ...
    [ProgramEntry("_ENTRY")]
    public partial class Custprmpt : ASNA.QSys.Runtime.JobSupport.Program
    {
        ...
        //                                                                         *  cursor location
        //********************************************************************
        DataStructure _DS2 = new DataStructure(32);
...
#region Entry and activation methods for *ENTRY
        ...
        {
            return new Custprmpt();
        }

        int _parms;

        void __ENTRY(out Indicator __inLR, bool _isNew, ref FixedString<_10> _pCsrFld, ref FixedString<_10> _pResult)
        {
            int _pc_parms = 2;
            bool _cleanup = true;
            pResult = _pResult;
        ...
        public static void _ENTRY(ICaller _caller, out Indicator __inLR, ref FixedString<_10> pCsrFld, ref FixedString<_10> pResult)
        {
            ...
            bool _isNew = false;
            Custprmpt _instance = null;
            __inLR = '0';
            _instance = _manager.GetInstance(typeof(Custprmpt), _classFactory, _caller, out _isNew) as Custprmpt;
            try
            {
                _instance.__ENTRY(out __inLR, _isNew, ref pCsrFld, ref pResult);
            }
            catch
            {
                __inLR = '1';
